...
public class UserService {
    ...
    public int signUpUser(@RequestBody UserDto userDto) throws MessagingException {
        ...
        String emailBody = "<html><h2>Click on the below link to confirm your account</h2><a href='http://localhost:8080/user/confirmUser/"+generatedUserId+"'>Confirm User</a></html>";
